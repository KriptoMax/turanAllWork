...
import com.example.studyproject2.databinding.ActivityEightTaskBinding

class EightTaskActivity : AppCompatActivity() {

    private var _binding: ActivityEightTaskBinding? = null
    private val binding
        get() = _binding ?: throw IllegalStateException("Binding for OneTaskActivity must not be null")

    override fun onCreate(savedInstanceState: Bundle?){
        super.onCreate(savedInstanceState)
        _binding = ActivityEightTaskBinding.inflate(layoutInflater)
        enableEdgeToEdge()
