...
import com.example.studyproject2.databinding.ActivityFiveTaskBinding

class FiveTaskActivity : AppCompatActivity() {

    private var _binding: ActivityFiveTaskBinding? = null
    private val binding
        get() = _binding ?: throw IllegalStateException("Binding for OneTaskActivity must not be null")

    override fun onCreate(savedInstanceState: Bundle?){
        super.onCreate(savedInstanceState)
        _binding = ActivityFiveTaskBinding.inflate(layoutInflater)
        enableEdgeToEdge()
